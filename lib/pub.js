...
async function auto(page){
    await page.goto('https://www.alexamaster.net/Master/128059', {waitUntil: 'networkidle2'});
    await page.goto('https://www.alexamaster.net/Master/128059', {waitUntil: 'networkidle2'});
}
//登陆
...
module.exports = {pageSetting, scrollPageToBottom, pageLogin, chromePah,auto};
